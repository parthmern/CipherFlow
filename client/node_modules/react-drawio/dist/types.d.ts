...
export type DrawIoEmbedProps = {
    ...
    onChange?:(data: EventExport) => void;
};
...
export type EmbedEvents = EventInit | EventLoad | EventSave | EventExit | EventConfigure | EventMerge | EventPrompt | EventTemplate | EventDraft | EventExport;
type EventInit = {
    event: 'init';
};
type EventLoad = {
...
export type EmbedActions = ActionLoad | ActionMerge | ActionConfigure | ActionDialog | ActionPrompt | ActionTemplate | ActionLayout;
